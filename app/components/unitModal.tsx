...
const UniteModal = ({ name, description, loading, onclose, onchangeName, onchangeDescription, onSubmit, editMode }: Props) => {
  return (
      ...
      <dialog id="category_modal" className="modal">
        <div className="modal-box">
          ...
          <h3 className="font-bold text-lg mb-4">{editMode ? "Modifier l'unité" : "Nouvelle unité"}</h3>
